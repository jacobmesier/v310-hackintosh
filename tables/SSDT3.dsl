 ...
 *
 * Disassembly of SSDT3, Thu May  2 00:19:52 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003791 (14225)
 *     Revision         0x02
 *     Checksum         0xBB
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0x9BF8BD18, 0x01F7)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Device (DD1F)
        {
            ...
            {
                Store (DerefOf (Index (BRTD, Arg0)), Local0)
                Return (Local0)
            }
